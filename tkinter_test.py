...
window = tk.Tk()
window.title("Calculator_from_kOSD")
...
btn_reiz = tk.Button(window, text = "*", command = lambda: add_to_field("*"), width = 5, font = ("Times New Roman", 14))
btn_reiz.grid(row = 3, column = 4)

btn_dal = tk.Button(window, text = "/", command = lambda: add_to_field("/"), width = 5, font = ("Times New Roman", 14))
btn_dal.grid(row = 2, column = 4)

btn_clear = tk.Button(window, text = "clear", command = lambda: clear(), width = 5, font = ("Times New Roman", 14))
btn_clear.grid(row = 5, column = 3)

btn_dec = tk.Button(window, text = ".", command = lambda: add_to_field("."), width = 5, font = ("Times New Roman", 14))
btn_dec.grid(row = 5, column = 2)

btn_right = tk.Button(window, text = "(", command = lambda: add_to_field("("), width = 5, font = ("Times New Roman", 14))
btn_right.grid(row = 6, column = 1)

btn_left = tk.Button(window, text = ")", command = lambda: add_to_field(")"), width = 5, font = ("Times New Roman", 14))
btn_left.grid(row = 6, column = 2)
